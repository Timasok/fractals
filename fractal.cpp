...
int FormMandelbrot(RenderWindow &window, Uint8 *pixels)
{
    ...
    for (; yi < Mandb_Initial.w_height; yi++)
    {
        ...
        for(; xi < Mandb_Initial.w_width; xi++)
        {
            ...
            // pixels[yi*Mandb_Initial.w_width+xi] = (Uint8) col;

            pixels[4*yi*Mandb_Initial.w_width+4*xi+0] = (Uint8) col.r;
            pixels[4*yi*Mandb_Initial.w_width+4*xi+1] = (Uint8) col.g;
            pixels[4*yi*Mandb_Initial.w_width+4*xi+2] = (Uint8) col.b;
            pixels[4*yi*Mandb_Initial.w_width+4*xi+3] = (Uint8) col.a;
